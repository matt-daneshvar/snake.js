var SnakeJs = SnakeJs || {}; SnakeJs["Game"] =
...
var _Seed = __webpack_require__(3);
...
var Game = function () {
    ...
    _createClass(Game, [{
        ...
        value: function start() {
            ...
            this.canvas.spawn(new _Seed2.default());
            this.play();
        }
    }, {
        key: 'end',
        ...
        value: function step() {
            ...
            try {
                for (var _iterator = this.canvas.objects[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            ediblesCount < 1 ? this.canvas.spawn(new _Seed2.default()) : null;
            ...
            try {
                for (var _iterator2 = this.snake.shed[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    var position = _step2.value;

                    this.canvas.spawn(new _Seed2.default(), position.x, position.y);
                }
            } catch (err) {
        ...
        value: function render() {
            ...
            var $canvas = $('#canvas');
            $canvas.attr('class', '');
            $canvas.addClass(this.playing ? 'playing' : 'paused').addClass(this.over ? 'over' : '');
            $canvas.html('');
            for (var i in this.canvas.objects) {
                var object = this.canvas.objects[i];
                for (var j in object.body) {
                    var position = object.body[j];
...
var _Direction = __webpack_require__(0);
...
var Snake = function () {
    ...
    _createClass(Snake, [{
        key: 'go',
        value: function go(direction) {
            if (!_Direction2.default.exists(direction) || _Direction2.default.isOpposite(direction, this.direction)) {
                return;
            }
...
var _rand = __webpack_require__(5);
...
var Canvas = function () {
    ...
    _createClass(Canvas, [{
        ...
        value: function spawn(object) {
            ...
            var position = arguments.length === 3 ? { x: arguments[1], y: arguments[2] } : this.random(padding);
            ...
            if (typeof object.direction !== 'undefined') {
                object.direction = _Direction2.default.random();
            }
        ...
        value: function random() {
            ...
            return {
                x: (0, _rand2.default)(this.bounds.x1 + padding, this.bounds.x2 - padding - 1),
                y: (0, _rand2.default)(this.bounds.y1 + padding, this.bounds.y2 - padding - 1)
            };
        }
    }]);
